    ...
    for (var i = 0; i < inputs.length; i++) {
        ...
        if (inputs[i].tagName == 'INPUT') {
            switch (inputs[i].type) {
                case "password":
                    answer = new AnswerofWizard(inputs[i].value, name, email, parseInt(inputs[i].id));
                    break;
                case "radio":
                    answer = new AnswerofWizard("" + inputs[i].checked + "",  name, email, parseInt(inputs[i].id));
                    break;
                case "checkbox":
                    answer = new AnswerofWizard("" + inputs[i].checked + "", name, email, parseInt(inputs[i].id));
                    break;
            ...
            answer = new AnswerofWizard(inputs[i].selected +"", name, email, parseInt(inputs[i].id));
            AnswersStorage.Addanswer(answer);
        }
    }
